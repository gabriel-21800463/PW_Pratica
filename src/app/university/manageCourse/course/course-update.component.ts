...
export class CourseUpdateComponent implements OnInit {
  ...
  private createForm() {
    this.courseForm = new FormGroup({
      ...
      teacher: new FormControl('', [Validators.required, Validators.maxLength(25)]),
      ...
      specialization: new FormControl('', [Validators.required, Validators.maxLength(30)]),
      grau: new FormControl('', [Validators.required]),
      disciplina: new FormControl('', [Validators.required, Validators.maxLength(25)]),
